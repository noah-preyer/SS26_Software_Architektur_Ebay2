...
Dominik Duken 123456\\
Noah Preyer 234567\\
Ilker Türk 345678\\[8pt]
Juli 2026
\vspace*{\fill}
\end{titlepage}
\clearpage
...
\input{01-einleitung}
\input{02-randbedingungen}
\include{03-kontextabgrenzung}
\include{04-loesungsstrategie}
\include{05-bausteinsicht}
\include{06-laufzeitsicht}
\include{07-verteilungssicht}
\include{08-konzepte}
\include{09-adrs}
\include{10-qualitaet}
\include{11-risiken}
\include{12-glossar}
