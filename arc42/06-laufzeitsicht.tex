...
\subsection{Registrierung eines Nutzers}

Das API Gateway leitet die Registrierungsdaten an den User Service weiter.
Dieser prüft, ob Benutzername und E-Mail-Adresse bereits vergeben sind, und
legt anschließend die Zugangsdaten über den Auth Service an.
Danach wird das Benutzerprofil gespeichert.

Schlägt das Speichern des Profils fehl,
wird der zuvor angelegte Auth-Benutzer durch einen kompensierenden Aufruf wieder gelöscht.
Der Ablauf ist in Abbildung~\ref{fig:registrierung} dargestellt.

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,trim=5cm 3cm 5cm 2cm,clip]{images/08-sequenz-registrierung}
    \caption{Registrierung eines Nutzers}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,trim=0cm 4cm 0.5cm 3cm,clip]{images/04-sequenz-login.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,trim=0.5cm 1.5cm 2.5cm 2cm,clip]{images/03-sequenz-checkout.pdf}
