// fallback-daten wenn das backend nicht erreichbar ist, nur für lesende produkt-calls.

export const KATEGORIEN = ["Elektronik", "Kleidung", "Möbel", "Sport", "Fahrzeuge"];

// für den demo-button im login wenn das backend down ist.
export const mockUsers = [
  { id: 1, username: "max_mueller", email: "max@example.com" },
  { id: 2, username: "anna_schmidt", email: "anna@example.com" },
  { id: 3, username: "tom_wagner", email: "tom@example.com" },
  { id: 4, username: "lisa_braun", email: "lisa@example.com" },
  { id: 5, username: "demo_user", email: "demo@example.com" },
];
...
export function mockGetProduct(id) {
  return fallbackProducts.find((p) => p.id === Number(id));
}
